...
<div x-floating:arrow
      x-bind:class="{
           '-mb-1.5 rotate-180': $floating.placementSide === 'top',
           '-mt-1.5': $floating.placementSide === 'bottom',
           '-ml-1.5 -rotate-90': $floating.placementSide === 'right',
           '-mr-1.5 rotate-90': $floating.placementSide === 'left',
      }"
