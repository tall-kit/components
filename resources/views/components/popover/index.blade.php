...
<template x-teleport="body">
    <div x-cloak
         x-popover="{{json_encode(['placement' => $placement])}}"
    ...
    >
        ...
        @if($arrow)
            <div x-popover:arrow
                 x-bind:class="{
                       '-mb-1.5 rotate-180': $popover.placementSide === 'top',
                       '-mt-1.5': $popover.placementSide === 'bottom',
                       '-ml-1.5 -rotate-90': $popover.placementSide === 'right',
                       '-mr-1.5 rotate-90': $popover.placementSide === 'left',
                  }"
