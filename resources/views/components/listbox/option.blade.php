...
<div x-listbox:option="{{json_encode($data)}}"
     x-bind:class="{
        'bg-[var(--background)] text-[color:var(--foreground)] border-[var(--border)]': $listboxOption.isActive,
     ...
     {{$attributes
        ...
        ->class([
            ...
            'flex items-center relative cursor-default select-none py-2 pl-2 pr-9 mx-1 rounded-md text-sm outline-none'
        ])}}>
