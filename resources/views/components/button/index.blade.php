...
<{{$tag}} {{$attributes
            ...
            ->class([
                ...
                match ("$variant-$color") {
                    ...
                    'link-primary' => 'border-transparent text-primary-dark enabled:hover:underline focus:ring-primary-light',
                    // Secondary variants
                    ...
                    'link-secondary' => 'border-transparent text-secondary-dark enabled:hover:underline focus:ring-secondary-light',
                    // Neutral variants
                    ...
                    'link-neutral' => 'border-transparent text-neutral-dark enabled:hover:underline focus:ring-neutral-light',
                    // Success variants
                    ...
                    'link-success' => 'border-transparent text-success-dark enabled:hover:underline focus:ring-success-light',
                    // Warning variants
                    ...
                    'link-warning' => 'border-transparent text-warning-dark enabled:hover:underline focus:ring-warning-light',
                    // Error variants
                    ...
                    'link-error' => 'border-transparent text-error-dark enabled:hover:underline focus:ring-error-light',
                },
                match ($size) {
